    ...
    <TabControl Background="#FF161719">
        ...
        <TabItem Header="Shortcut" Background="#FF7E84D4">
            <Grid Background="#FF161719">
                ...
                <TextBlock HorizontalAlignment="Center" Margin="0,90,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="198" Foreground="#FFCE8484"><Run Text="Welche Aktion m"/><Run Language="de-ch" Text="oe"/><Run Text="chtest du starten?"/></TextBlock>
